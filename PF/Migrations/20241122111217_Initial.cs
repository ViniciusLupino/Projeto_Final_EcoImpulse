    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StatusPedidos", x => x.IdStatusPedido);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StatusPedidoIdStatusPedido = table.Column<int>(type: "int", nullable: false),
                    Deletado = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        column: x => x.StatusPedidoIdStatusPedido,
            ...
            migrationBuilder.CreateTable(
                name: "DetalheCarrinhos",
                columns: table => new
                {
                    IdDetalheCarrinho = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DetalheCarrinhos", x => x.IdDetalheCarrinho);
                    table.ForeignKey(
                        name: "FK_DetalheCarrinhos_Carrinhos_CarrinhoId",
                        column: x => x.CarrinhoId,
                        principalTable: "Carrinhos",
                        principalColumn: "IdCarrinho",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DetalheCarrinhos_Produtos_ProdutoId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IdDetalhePedido = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DetalhesPedidos", x => x.IdDetalhePedido);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DetalheCarrinhos_CarrinhoId",
                table: "DetalheCarrinhos",
                column: "CarrinhoId");

            migrationBuilder.CreateIndex(
                name: "IX_DetalheCarrinhos_ProdutoId",
                table: "DetalheCarrinhos",
                column: "ProdutoId");
