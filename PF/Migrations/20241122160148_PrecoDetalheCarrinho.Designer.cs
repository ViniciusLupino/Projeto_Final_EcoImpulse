...
namespace PF.Migrations
{
    ...
    [Migration("20241122160148_PrecoDetalheCarrinho")]
    partial class PrecoDetalheCarrinho
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("PF.Models.Pedido", b =>
                {
                    ...
                    b.Property<int>("StatusPedidoIdStatusPedido")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("StatusPedidoIdStatusPedido");
            ...
            modelBuilder.Entity("PF.Models.Pedido", b =>
                {
                    b.HasOne("PF.Models.StatusPedido", "StatusPedido")
                        .WithMany()
                        .HasForeignKey("StatusPedidoIdStatusPedido")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
